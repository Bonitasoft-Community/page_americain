...
public class ParametersOperation {
		...
		public static List<String> listParametersOperation = Arrays.asList("optoperationgroups", "optoperationroles", "optoperationusers", "optoperationmemberships", "optoperationprofiles",
						"optoperationprofilemembers", "optpurgegroups", "optpurgeroles", "optpurgeusers", "optpurgememberships", "optpurgeprofiles", "optpurgeprofilemembers", "optregisternewuserinprofileuser");
		...
		public static ParametersOperation getInstance(Map<String, String> parameters) {
				...
				try {
						...
						parametersOperation.operationProfileMembers = parameters.get("optoperationprofilemembers") == null ? OperationOnItem.BOTH : OperationOnItem.valueOf(parameters
										.get("optoperationprofilemembers"));
						...
						parametersOperation.registerNewUserInProfileUser = parameters.get("optregisternewuserinprofileuser") == null ? RegisterNewUserInProfile.NONE : RegisterNewUserInProfile.valueOf(parameters
										.get("optregisternewuserinprofileuser"));
		...
		public String getInfos() {
				return "operationGroups[" + operationGroups + "] operationRoles[" + operationRoles + "] operationUsers[" + operationUsers + "] operationMemberships[" + operationMemberships
								+ "] operationProfiles[" + operationProfiles + "] operationProfileMembers[" + operationProfileMembers + "] purgeGroups[" + purgeGroups + "] purgeRoles[" + purgeGroups
								+ "] purgeUsers[" + purgeUsers + "] purgeMembership[" + purgeMembership + "] purgeProfile[" + purgeProfile + "] purgeProfileMember[" + purgeProfileMember
								+ "] registerNewUserInProfileUser[" + registerNewUserInProfileUser + "]";
