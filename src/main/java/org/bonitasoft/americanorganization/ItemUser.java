...
public class ItemUser extends Item {
    ...
    public ItemUser(final String userName, final String userPassword, final boolean userEnable, final String userFirstName, final String userLastName, final String userIconName, final String userIconPath, final String userTitle, final String userJobTitle, final String userManagerUserName,
            final String proContactAddress, final String proContactBuilding, final String proContactCity, final String proContactCountry, final String proContactEmail, final String proContactFaxNumber, final String proContactMobileNumber, final String proContactPhoneNumber,
            final String proContactRoom, final String proContactState, final String proContactWebSite, final String proContactZipCode, final String perContactAddress, final String perContactBuilding, final String perContactCity, final String perContactCountry, final String perContactEmail,
            final String perContactFaxNumber, final String perContactMobileNumber, final String perContactPhoneNumber, final String perContactRoom, final String perContactState, final String perContactWebSite, final String perContactZipCode) {
